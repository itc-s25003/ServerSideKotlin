...
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookMapper
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.insert
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.record.Book as BookRecord
...
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.deleteByPrimaryKey
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.select
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.selectOne
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.updateByPrimaryKey
