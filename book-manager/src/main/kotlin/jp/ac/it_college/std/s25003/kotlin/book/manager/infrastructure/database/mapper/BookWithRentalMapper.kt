...
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.author
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.bookWithRental
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.id
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.releaseDate
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.rentalDatetime
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.returnDeadline
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.title
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.BookWithRentalDynamicSqlSupport.userId
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.record.BookWithRental
