...
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.email
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.id
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.name
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.password
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.roleType
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.mapper.UserDynamicSqlSupport.user
import jp.ac.it_college.std.s25003.kotlin.book.manager.infrastructure.database.record.User
